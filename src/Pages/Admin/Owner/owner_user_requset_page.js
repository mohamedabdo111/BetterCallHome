...
import OwnerUserRequest from "../../../Components/Owner/owneruserrequest";
const OwnerUserRequestPage = () => {
    ...
    <Container>
      <Row className="py-2">
        ...
        <Col xs="8" sm="8" md="9" className="overviewtog">
          <OwnerUserRequest></OwnerUserRequest>
        </Col>
      </Row>
    </Container>
  );
...
export default OwnerUserRequestPage;
